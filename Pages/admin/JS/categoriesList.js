        ...
        $(".list tbody").append(
            `
                <tr>
                    ...
                    <td>
                        <a href="#" data-toggle="modal" data-target="#addAndUpdateCategoryModal" onclick="openUpdateCategory(${item.id})">Xem/Sửa</a><br>
...
function openAddCategoryModal() {
    ...
    $.get("http://localhost:8080/api/v1/categories/existed/" + name, function (data, status) {
        ...
        if (data) {
            // show error message
            showFieldErrorMessage("modal-input-errMess-name", "modal-title", "Sản phẩm này đã tồn tại!");
            return;
        } else {
