var baseUrl = "http://localhost:8080/api/v1/auth/login";
...
function showLoginFailMessage() {
    showFieldErrorMessage("incorrect-mess", "username", "Đăng nhập thất bại , vui lòng thử lại!");
    showFieldErrorMessage("incorrect-mess", "password", "Đăng nhập thất bại , vui lòng thử lại!");
}
